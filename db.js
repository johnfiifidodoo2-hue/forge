...
const store = {
  users: [
    ...
    {
      id: 7,
      email: 'nora@forge.dev',
      name: 'Nora Mensah',
      password: DEMO_HASH,
      role: 'CREATOR',
      bio: 'Embedded-systems engineer building practical edge-AI tools for factories and field teams.',
      skills: 'C++, Embedded Linux, FPGA, Computer Vision, MQTT',
      portfolioUrl: 'https://github.com',
      whatsappNumber: '+233240001001',
      preferredTheme: 'DARK',
      createdAt: new Date(),
    },
    {
      id: 8,
      email: 'daniel@forge.dev',
      name: 'Daniel Owusu',
      password: DEMO_HASH,
      role: 'CREATOR',
      bio: 'Product-minded backend developer interested in reliable systems and developer experience.',
      skills: 'Node.js, PostgreSQL, Redis, API Design, Observability',
      portfolioUrl: 'https://github.com',
      whatsappNumber: '+233240001002',
      preferredTheme: 'LIGHT',
      createdAt: new Date(),
    },
    {
      id: 9,
      email: 'leila@forge.dev',
      name: 'Leila Haddad',
      password: DEMO_HASH,
      role: 'CREATOR',
      bio: 'Interaction designer translating complex ML and infrastructure tools into usable products.',
      skills: 'Figma, UX Research, Data Visualisation, Design Systems',
      portfolioUrl: 'https://dribbble.com',
      whatsappNumber: '+233240001003',
      preferredTheme: 'LIGHT',
      createdAt: new Date(),
    },
  ],
  projects: [
    ...
    },
    {
      ...
      description: 'A browser-based teaching and debugging tool that turns a CPU cache trace into an interactive L1/L2/DRAM timeline. Users can compare direct-mapped, set-associative, and fully-associative caches; change line size and replacement policy; and see compulsory, capacity, and conflict misses in real time. The first classroom pilot has 48 computer-engineering students and a target of reducing cache-analysis lab time by 30%.',
      tags: 'computer-architecture, cache, memory-hierarchy, education, visualisation, web',
      ownerId: 9,
      initialUpvotes: 29,
    ...
    },
    {
      ...
      description: 'An offline-tolerant telemetry platform for refrigerated-food delivery. LoRaWAN gateways batch signed temperature readings; a Node.js ingestion API writes an idempotent event stream; and a dashboard highlights excursions before a shipment spoils. We have two pilot fleets, 36 sensors, 99.2% successful uplinks, and are validating alert latency under intermittent connectivity.',
      tags: 'iot, distributed-systems, observability, logistics, node-js, edge-compute',
      ownerId: 7,
      initialUpvotes: 41,
  ...
  comments: [
    ...
    {
      id: 8,
      content: 'The cache visualiser is exactly what I wanted when learning associativity. Please include a mode that highlights when a prefetch helps throughput but increases wasted bandwidth.',
      projectId: 10,
      authorId: 7,
    ...
    {
      id: 9,
      content: 'For the cold-chain pilot, I would model every sensor upload with a stable device ID and idempotency key. You will eventually receive duplicates after gateway retries, especially when connectivity returns.',
      projectId: 11,
      authorId: 8,
    ...
    {
      id: 10,
      content: 'EdgeTensor’s UI should expose accuracy, latency, and power together. A field operator does not need microarchitecture jargon, but they do need to trust why a model was selected.',
      projectId: 9,
      authorId: 9,
      createdAt: new Date('2026-09-04T15:45:00Z'),
    },
  ],
  upvotes: [
    ...
    { id: 7, userId: 7, projectId: 10 },
    { id: 8, userId: 8, projectId: 10 },
    { id: 9, userId: 9, projectId: 11 },
  ],
  saves: [
    { id: 1, userId: 1, projectId: 1 },
  ],
  resources: [
    ...
    },
    {
      ...
      description: 'A clear visual walkthrough of cache organisation, locality, cache levels, and memory access—excellent preparation before exploring CacheScope-style traces.',
    ...
    },
    {
      ...
      description: 'YouTube learning path for GPU execution, memory access patterns, CUDA, and parallel matrix computation.',
    ...
    },
    {
      ...
      description: 'Step-by-step video lesson on building a RISC-V processor datapath, control unit, register file, ALU, and data memory in Verilog.',
    ...
    },
    {
      ...
      description: 'YouTube learning path on caching, CDNs, latency, consistency, and real product infrastructure decisions.',
