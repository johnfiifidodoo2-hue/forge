...
const store = {
  ...
  resources: [
    {
      id: 1,
      title: 'Next.js 14 Production Starter Kit & Server Actions',
      description: 'Official production-grade boilerplate for Next.js App Router with TypeScript, Tailwind CSS, and Prisma ORM.',
    ...
    {
      id: 2,
      title: 'RISC-V ISA Specification & Verilog Coprocessor Core',
      ...
      githubUrl: 'https://github.com/riscv/riscv-isa-manual',
      category: 'HARDWARE',
      sharedById: 2,
    ...
    {
      id: 3,
      title: 'Y Combinator SAFE Investor Template & Terms',
      ...
      githubUrl: 'https://github.com/ycombinator',
      category: 'TEMPLATE',
      sharedById: 3,
    ...
    {
      id: 5,
      title: 'Figma Community Design System & UI Kit 2024',
    ...
    {
      id: 6,
      title: 'CUDA Tensor Core Matrix Multiplication Kernels',
    ...
    },
    {
      ...
      description: 'The definitive academic reference covering instruction-level parallelism, cache hierarchy, and memory buses.',
      url: 'https://www.eecs.harvard.edu/~dbrooks/cs146-spring2004/',
      githubUrl: 'https://github.com/chipsalliance',
      category: 'GUIDE',
      sharedById: 2,
    ...
    },
    {
      ...
      githubUrl: 'https://github.com/angellist',
      category: 'TEMPLATE',
      sharedById: 3,
